...
const AddProduct = () => {
  ...
  return (
    <form>
      <h1 className="font-bold text-[28px] font-[600] dark:text-gray-200">
        Create product
      </h1>
      <div className="flex gap-5 mt-3">
        <div className="w-[50%] flex flex-col gap-3">
          <div className="card dark:bg-themeDark w-full p-4 dark:border-[rgba(255,255,255,0.1)]">
            <h2 className="text-[18px] font-[600] mb-4 dark:text-gray-200">
              Basic Information
            </h2>
        ...
        <div className="w-[50%] flex flex-col gap-3">
          <div className="card  dark:bg-themeDark w-full p-4 dark:border-[rgba(255,255,255,0.1)]">
            <h2 className="text-[18px] font-[600] mb-3 dark:text-gray-200">
              Product Image
            </h2>
